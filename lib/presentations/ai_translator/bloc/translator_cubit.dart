// language_cubit.dart
import 'package:ad_english_dictionary/presentations/ai_translator/bloc/translator_state.dart';
...
class LanguageCubit extends Cubit<LanguageState> {
  LanguageCubit()
    ...
    selectedLanguage2: 'German',
  ));

  void updateLanguage1(String lang) {
    emit(state.copyWith(selectedLanguage1: lang));
  }

  void updateLanguage2(String lang) {
    emit(state.copyWith(selectedLanguage2: lang));
  }

  final Map<String, String> languageCodesC = {
    'English': 'en',
    'French': 'fr',
    'Spanish': 'es',
    'German': 'de',
  ...
  final languageFlags = {
    ...
    'Catalan': 'ES', // Spain (Catalonia)
    'Chinese (Simplified)': 'CN', // China
    'Chinese (Traditional)': 'TW', // Taiwan
    'Croatian': 'HR', // Croatia
    ...
    'Kurdish': 'IQ', // Iraq (Kurdistan Region)
    'Latvian': 'LV', // Latvia
    ...
    'Persian': 'IR', // Iran
    'Polish': 'PL', // Poland
    'Portuguese (Portugal)': 'PT', // Portugal
    'Punjabi': 'PK', // Pakistan
    'Romanian': 'RO', // Romania
    'Russian': 'RU', // Russia
    'Serbian': 'RS', // Serbia
